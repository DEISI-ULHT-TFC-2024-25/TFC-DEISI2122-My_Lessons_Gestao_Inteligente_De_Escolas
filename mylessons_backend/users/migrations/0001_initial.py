    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_role', models.CharField(default='Parent', max_length=255)),
                ('current_school_id', models.PositiveIntegerField(blank=True, null=True)),
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('balance_history', models.JSONField(blank=True, default=list, null=True)),
                ('payment_types', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to='schools.school')),
                ('user', models.ForeignKey(help_text='User associated with the discount', on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(help_text='The user associated with these Google credentials', on_delete=django.db.models.deletion.CASCADE, related_name='google_credential', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(blank=None, null=None)),
                ('parents', models.ManyToManyField(related_name='students', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unavailabilities', to='schools.school')),
