...
class EquipmentAdmin(admin.ModelAdmin):
    list_display = ('name', 'state', 'location', 'is_being_used', 'nothing_missing')  # Fields to display in the list view
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'location', 'state', 'photo')
        }),
        ('Status', {
            'fields': ('is_being_used', 'nothing_missing')
        }),
        ('Additional Info', {
            'fields': ('usages',),
        }),
